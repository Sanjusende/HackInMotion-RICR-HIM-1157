...
const options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description: "Enterprise-grade REST API powering the KrishiMitra agricultural platform. Integrates climate telemetry, mandi market dynamics, and machine learning models.",
      contact: {
