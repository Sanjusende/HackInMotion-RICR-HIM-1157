            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip
                  ...
                  formatter={(val, name) => [
                    `${val} L`,
                    name === 'actual' ? 'Actual Water' : 'Recommended',
                  ]}
                />
                <Line
                  type="monotone"
