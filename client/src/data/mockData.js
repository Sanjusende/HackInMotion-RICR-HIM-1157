...
export const faqData = [
  {
    ...
    answer:
      'Our recommendations are backed by historical climate patterns, local weather projections, and soil NPK chemistry inputs, achieving a proven historical yield recommendation accuracy rate of over 94%.',
  },
  {
    question: 'Do I need physical soil sensors to use KrishiMitra?',
    answer:
      'No, while sensors improve accuracy, you can easily enter details from standard lab soil cards or choose your regional estimates to get instant advisory recommendations.',
  },
  {
    question: 'Is there support for local regional languages?',
    answer:
      'Yes, KrishiMitra supports multiple languages including English, Hindi (हिन्दी), Marathi (मराठी), Punjabi (ਪੰਜਾਬੀ), and Telugu (తెలుగు) directly in the settings.',
  },
  {
    question: 'How frequently is the weather forecast updated?',
    answer:
      'Our micro-climate weather forecasts update every hour, giving you immediate warnings about frost, rain patterns, and optimal crop spraying schedules.',
  },
  {
    question: 'Can I track my seasonal farming expenses?',
    answer:
      'Yes, the expense tracking module lets you split budgets across seeds, fertilizers, labor, and irrigation, generating structured reports at harvest.',
  },
];
...
export const timelineSteps = [
  {
    ...
    description:
      'Create your free digital farmer account in under 60 seconds with simple location settings.',
  },
  {
    number: '2',
    title: 'Create Farm Profile',
    description:
      'Enter your farm size, primary soil texture parameters, and existing irrigation options.',
  },
  {
    number: '3',
    title: 'Receive AI Insights',
    description:
      'Our machine learning engine processes your soil profile to recommend optimal crops and sowing schedules.',
  },
  {
    number: '4',
    title: 'Improve Yield',
    description:
      'Follow real-time advisory alerts on fertilizer schedules and weather risks to maximize your profits.',
  },
];
...
export const featuresList = [
  {
    ...
    description:
      'Hour-by-hour local forecasting combined with historical weather registries to warn you about temperature drops or storms.',
  ...
  },
  {
    ...
    description:
      'Deep learning models select optimal crop sets matching soil textures, nutrient balances, and seasonal water indices.',
  ...
  },
  {
    ...
    description:
      'Upload leaf photos to scan and diagnose early plant symptoms, receiving precise remedial spraying guidelines.',
  ...
  },
  {
    ...
    description:
      'Track Nitrogen (N), Phosphorus (P), Potassium (K), soil acidity, and organic carbon levels via easy-to-read charts.',
  ...
  },
  {
    ...
    description:
      'Calculates evaporation indices, plant transpiration, and soil moisture levels to guide water application.',
  ...
  },
  {
    ...
    description:
      'Monitors supply-demand indices across nearest regional markets, forecasting upcoming commodity peaks.',
  ...
  },
  {
    ...
    description:
      'Log farm input expenses, rentals, seed costs, and harvest yields in a centralized financial register.',
  ...
  },
  {
    ...
    description:
      'Export summary crop cards, soil tests, and yield charts to PDF summaries with one click.',
  ...
  },
  {
    ...
    description:
      'Enables hands-free farming updates and daily alerts via simple spoken queries in regional languages.',
  ...
  },
  {
    ...
    description:
      'A 24/7 virtual agronomist ready to answer crop health queries, seedling care, and insect controls.',
...
export const testimonials = [
  {
    ...
    review:
      "Implementing KrishiMitra's NPK soil schedule increased my wheat yield by 28% while dropping fertilizer costs by nearly a third.",
    avatar: '👨‍🌾',
  },
  {
    ...
    review:
      'The smart weather notification saved my grape orchard from a severe frost warning. I was able to prepare protective cover sheets just in time.',
    avatar: '👩‍🌾',
  },
  {
    name: 'Sukhdev Singh',
    ...
    review:
      'As a commercial farmer, having commodity price forecasts helped me store my rice for 3 weeks and sell it at an 18% higher rate.',
    avatar: '👨‍🌾',
  },
];
