...
const Landing = () => {
  ...
  return (
    <div id="home" className="relative bg-[#F8FAF6] text-slate-900 overflow-hidden font-sans selection:bg-emerald-600 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-left">
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 pt-2">
                <Link to="/register" className="w-full sm:w-auto">
                  <Button variant="primary" size="lg" className="w-full sm:w-auto shadow-lg shadow-emerald-700/20 font-bold flex items-center justify-center gap-2 text-sm sm:text-base px-7 py-3.5 rounded-2xl hover:scale-[1.02] transition-all">
                    Get Started <ArrowRight size={18} />
                  </Button>
                </Link>

                <a href="#features" onClick={(e) => handleSmoothScroll(e, 'features')} className="w-full sm:w-auto">
                  <Button variant="secondary" size="lg" className="w-full sm:w-auto font-bold text-sm sm:text-base px-6 py-3.5 rounded-2xl border-emerald-200 text-slate-700 hover:bg-emerald-50/80 transition-all justify-center">
                    Explore Features
                  </Button>
                </a>
              </motion.div>

              <motion.div variants={itemVariants} className="pt-4 border-t border-emerald-100 flex flex-wrap items-center gap-4 sm:gap-6 text-xs font-semibold text-slate-600">
                <div className="flex items-center gap-1.5 text-emerald-800">
                  <CheckCircle2 size={16} className="text-emerald-600 shrink-0" /> Real-time Weather Telemetry
                </div>
                <div className="flex items-center gap-1.5 text-emerald-800">
                  <CheckCircle2 size={16} className="text-emerald-600 shrink-0" /> Live Mandi Market Feeds
                </div>
                <div className="flex items-center gap-1.5 text-emerald-800">
                  <CheckCircle2 size={16} className="text-emerald-600 shrink-0" /> AI Voice & Leaf Diagnostics
                </div>
              </motion.div>
            </div>
              ...
              <div className="relative w-full max-w-md p-1.5 rounded-[2.5rem] bg-gradient-to-b from-emerald-400/30 via-emerald-200/20 to-transparent shadow-2xl backdrop-blur-xl">
                <div className="bg-white/95 backdrop-blur-md rounded-[2.2rem] border border-emerald-100 p-5 sm:p-6 shadow-xl space-y-4">
                  ...
                  <div className="p-3.5 bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border border-emerald-200/60 flex items-center justify-between shadow-sm gap-2">
                    <div className="flex items-center space-x-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs text-slate-500 font-semibold truncate">Local Farm Weather</p>
                        <p className="text-xs sm:text-sm font-extrabold text-slate-900 truncate">28°C • Clear Sky</p>
                      </div>
                    </div>
                  ...
                  <div className="p-4 bg-white rounded-2xl border border-slate-100 shadow-sm space-y-1.5">
                    <div className="flex justify-between items-center gap-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        <span className="text-xs font-extrabold text-slate-700 truncate">Irrigation Recommendation</span>
                      </div>
                  ...
                  <div className="p-3.5 bg-slate-900 text-white rounded-2xl flex items-center justify-between shadow-md gap-2">
                    <div>
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Wheat Mandi Price</span>
                      <p className="text-base sm:text-lg font-extrabold text-white">₹2,450 <span className="text-xs font-normal text-slate-300">/ Quintal</span></p>
                    </div>
      ...
      {/* 2. PROBLEM + SOLUTION */}
      {/* ======================================================== */}
      <section id="problem-solution" className="py-12 sm:py-16 md:py-20 bg-white border-t border-b border-emerald-100/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {problems.map((p, i) => {
              const Icon = p.icon;
              return (
                <div key={i} className="bg-slate-50/80 rounded-3xl p-5 sm:p-6 border border-slate-200/80 space-y-3 flex flex-col justify-start">
                  <div className={`w-11 h-11 rounded-2xl border ${p.color} flex items-center justify-center shrink-0`}>
                    <Icon size={22} />
                  </div>
          ...
          <div className="mt-8 sm:mt-10 p-6 sm:p-8 bg-gradient-to-r from-emerald-900 via-emerald-800 to-slate-900 text-white rounded-3xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 shadow-xl">
            <div className="space-y-2 text-left">
              <span className="text-xs font-bold text-emerald-300 uppercase tracking-wider block">The KrishiMitra Solution</span>
              <h3 className="text-xl sm:text-2xl font-extrabold text-white">One Connected Platform for Smarter Farming</h3>
            ...
            <Link to="/register" className="w-full lg:w-auto shrink-0">
              <Button variant="primary" size="md" className="w-full lg:w-auto font-bold bg-emerald-400 text-slate-950 hover:bg-emerald-300 justify-center">
                ...
                >
                  <div className="space-y-3.5">
                    <div className="flex items-center justify-between gap-2">
                      <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${feat.color} text-white flex items-center justify-center shadow-md group-hover:scale-105 transition-transform shrink-0`}>
                        <Icon size={24} />
                      </div>
      ...
      {/* 4. HOW IT WORKS */}
      {/* ======================================================== */}
      <section id="how-it-works" className="py-12 sm:py-16 md:py-24 bg-white border-t border-b border-emerald-100/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {steps.map((st, i) => {
              const Icon = st.icon;
              return (
                <div key={i} className="bg-slate-50/80 rounded-3xl p-6 sm:p-7 border border-slate-200/80 hover:bg-white hover:shadow-lg transition-all space-y-4 text-left flex flex-col justify-between">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto">
            {benefits.map((b, i) => {
              const Icon = b.icon;
              return (
                <div key={i} className="bg-white rounded-3xl p-5 sm:p-6 border border-emerald-100 shadow-sm hover:shadow-md transition-all space-y-3 text-left">
      ...
      {/* 6. TECHNOLOGY */}
      {/* ======================================================== */}
      <section id="tech" className="py-12 sm:py-16 md:py-20 bg-white border-t border-b border-emerald-100/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-12 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {techStack.map((t, i) => {
              const Icon = t.icon;
              return (
                <div key={i} className="bg-slate-50/80 rounded-2xl p-4 sm:p-5 border border-slate-200/80 hover:bg-white hover:border-emerald-300 transition-all flex items-start gap-3.5">
      ...
      <section id="about" className="py-12 sm:py-16 bg-[#F8FAF6]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="pt-4 sm:pt-6 space-y-3.5 text-left">
            <h3 className="text-lg sm:text-xl font-bold text-slate-900 text-center mb-6">Frequently Asked Questions</h3>
            {faqs.map((faq, i) => (
      ...
      {/* 8. FINAL CTA SECTION */}
      {/* ======================================================== */}
      <section id="get-started" className="py-12 sm:py-16 md:py-24 bg-white border-t border-emerald-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
